...
- **改缓存编排**：读 [cache.md](cache.md) §5–§6，本文仅描述 datasource 拉取层
...
- **文件**：`datasource/baostock_source.py`
...
- **计算**：`common/domain/settlement.py` 维护人民币资金账与原币展示账。组合市值、盈亏与 XIRR 使用人民币；当前市值以实时港币价格和本次计算取得的 HKD/CNY 汇率换算。
